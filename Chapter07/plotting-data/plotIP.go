// This program will read multiple log files and will create a
// graphical image with as many bars as the number of log files
// read. Each bar will represent the number of times a given IP
// address has been found in a log file.
package main
