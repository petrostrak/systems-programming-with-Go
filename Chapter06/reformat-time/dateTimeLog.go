// A program that reads a log file that contains date
// and time information, in order to convert the time
// format found in each log entry
package main
...
func main() {
	...
	for {
		...
		if r.MatchString(line) {
			...
			d1, err := time.Parse("02/Jan/2006:15:04:05 -0700",
				match[1])
			if err != nil {
				fmt.Println(err)
			}
